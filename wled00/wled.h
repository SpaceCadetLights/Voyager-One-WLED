...
#define WLED_CODENAME "Lightdrive Voyager One"
...
WLED_GLOBAL char apSSID[33] _INIT("Voyager One");                             // AP off by default (unless setup)
...
WLED_GLOBAL char serverDescription[33] _INIT("Voyager One");  // Name of module
...
WLED_GLOBAL char alexaInvocationName[33] _INIT("Voyager");          // speech control name of device. Choose something voice-to-text can understand
