...
//PIN CONFIGURATION
#ifndef LEDPIN
#define LEDPIN 27  //strip pin. Any for ESP32, gpio2 or 3 is recommended for ESP8266 (gpio2/3 are labeled D4/RX on NodeMCU and Wemos)
#endif
...
#ifndef BTNPIN
#define BTNPIN  13  //button pin. Needs to have pullup (gpio0 recommended)
#endif

#ifndef IR_PIN
#define IR_PIN  14  //infrared pin (-1 to disable)  MagicHome: 4, H801 Wifi: 0
#endif
